...
export function TweaksPanel({ title = "Tweaks", children }: TweaksPanelProps) {
  ...
  useEffect(() => {
    ...
    // Auto-open panel on local dev environment for easy access/manipulation
...
interface TweakSelectProps {
  label: string;
  value: string;
  options: (string | TweakSelectOption)[];
