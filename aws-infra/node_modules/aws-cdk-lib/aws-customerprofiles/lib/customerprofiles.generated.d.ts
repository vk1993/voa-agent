...
import { CalculatedAttributeDefinitionReference, DomainObjectTypeReference, DomainReference, EventStreamReference, EventTriggerReference, ICalculatedAttributeDefinitionRef, IDomainObjectTypeRef, IDomainRef, IEventStreamRef, IEventTriggerRef, IIntegrationRef, IntegrationReference, IObjectTypeRef, IRecommenderRef, ISegmentDefinitionRef, ObjectTypeReference, RecommenderReference, SegmentDefinitionReference } from "../../interfaces/generated/aws-customerprofiles-interfaces.generated";
/**
...
export declare class CfnCalculatedAttributeDefinition extends cdk.CfnResource implements cdk.IInspectable, ICalculatedAttributeDefinitionRef, cdk.ITaggableV2 {
     ...
     */
    private _attributeDetails;
    /**
     * The name of an attribute defined in a profile object type.
     */
    private _calculatedAttributeName;
    /**
     ...
     * Mathematical expression and a list of attribute items specified in that expression.
     */
    get attributeDetails(): CfnCalculatedAttributeDefinition.AttributeDetailsProperty | cdk.IResolvable;
    /**
     * Mathematical expression and a list of attribute items specified in that expression.
     */
    set attributeDetails(value: CfnCalculatedAttributeDefinition.AttributeDetailsProperty | cdk.IResolvable);
    /**
     * The name of an attribute defined in a profile object type.
     */
    get calculatedAttributeName(): string;
    /**
     * The name of an attribute defined in a profile object type.
     */
    set calculatedAttributeName(value: string);
    /**
     * The conditions including range, object count, and threshold for the calculated attribute.
     */
    get conditions(): CfnCalculatedAttributeDefinition.ConditionsProperty | cdk.IResolvable | undefined;
    /**
     * The conditions including range, object count, and threshold for the calculated attribute.
     */
    set conditions(value: CfnCalculatedAttributeDefinition.ConditionsProperty | cdk.IResolvable | undefined);
    /**
     * The description of the calculated attribute.
     */
     ...
     * Whether historical data ingested before the Calculated Attribute was created should be included in calculations.
     */
    get useHistoricalData(): boolean | cdk.IResolvable | undefined;
    /**
     * Whether historical data ingested before the Calculated Attribute was created should be included in calculations.
     */
    set useHistoricalData(value: boolean | cdk.IResolvable | undefined);
    /**
     ...
     */
    get attrReadiness(): cdk.IResolvable;
    /**
...
export declare class CfnDomain extends cdk.CfnResource implements cdk.IInspectable, IDomainRef, cdk.ITaggable {
     ...
     * Configuration and status of the data store for the domain.
     */
    get dataStore(): CfnDomain.DataStoreProperty | cdk.IResolvable | undefined;
    /**
     * Configuration and status of the data store for the domain.
     */
    set dataStore(value: CfnDomain.DataStoreProperty | cdk.IResolvable | undefined);
    /**
     * The URL of the SQS dead letter queue, which is used for reporting errors associated with ingesting data from third party applications.
     */
    get deadLetterQueueUrl(): string | undefined;
    /**
     * The URL of the SQS dead letter queue, which is used for reporting errors associated with ingesting data from third party applications.
     */
    set deadLetterQueueUrl(value: string | undefined);
    /**
     * The default encryption key, which is an AWS managed key, is used when no specific type of encryption key is specified.
     */
    get defaultEncryptionKey(): string | undefined;
    /**
     * The default encryption key, which is an AWS managed key, is used when no specific type of encryption key is specified.
     */
    set defaultEncryptionKey(value: string | undefined);
    /**
     * The default number of days until the data within the domain expires.
     */
     ...
     * The process of matching duplicate profiles.
     */
    get matching(): cdk.IResolvable | CfnDomain.MatchingProperty | undefined;
    /**
     * The process of matching duplicate profiles.
     */
    set matching(value: cdk.IResolvable | CfnDomain.MatchingProperty | undefined);
    /**
     * The process of matching duplicate profiles using Rule-Based matching.
     */
    get ruleBasedMatching(): cdk.IResolvable | CfnDomain.RuleBasedMatchingProperty | undefined;
    /**
     * The process of matching duplicate profiles using Rule-Based matching.
     */
    set ruleBasedMatching(value: cdk.IResolvable | CfnDomain.RuleBasedMatchingProperty | undefined);
    /**
     * The tags used to organize, track, or control access for this resource.
     */
     ...
     */
    get attrDataStoreReadiness(): cdk.IResolvable;
    /**
     ...
     */
    get attrRuleBasedMatchingStatus(): string;
    /**
     * Usage-specific statistics about the domain.
     *
     * @cloudformationAttribute Stats
     */
    get attrStats(): cdk.IResolvable;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnEventStream extends cdk.CfnResource implements cdk.IInspectable, IEventStreamRef, cdk.ITaggableV2 {
     ...
     * The name of the event stream.
     */
    get eventStreamName(): string;
    /**
     * The name of the event stream.
     */
    set eventStreamName(value: string);
    /**
     * The tags used to organize, track, or control access for this resource.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
     ...
     */
    get attrDestinationDetails(): cdk.IResolvable;
    /**
     * @cloudformationAttribute DestinationDetails.Status
     */
    get attrDestinationDetailsStatus(): string;
    /**
...
export declare class CfnIntegration extends cdk.CfnResource implements cdk.IInspectable, IIntegrationRef, cdk.ITaggable {
     ...
     * A list of unique names for active event triggers associated with the integration.
     */
    get eventTriggerNames(): Array<string> | undefined;
    /**
     * A list of unique names for active event triggers associated with the integration.
     */
    set eventTriggerNames(value: Array<string> | undefined);
    /**
     * The configuration that controls how Customer Profiles retrieves data from the source.
     */
    get flowDefinition(): CfnIntegration.FlowDefinitionProperty | cdk.IResolvable | undefined;
    /**
     * The configuration that controls how Customer Profiles retrieves data from the source.
     */
    set flowDefinition(value: CfnIntegration.FlowDefinitionProperty | cdk.IResolvable | undefined);
    /**
     * The name of the profile object type mapping to use.
     */
    get objectTypeName(): string | undefined;
    /**
     * The name of the profile object type mapping to use.
     */
    set objectTypeName(value: string | undefined);
    /**
     * The object type mapping.
     */
    get objectTypeNames(): Array<cdk.IResolvable | CfnIntegration.ObjectTypeMappingProperty> | cdk.IResolvable | undefined;
    /**
     * The object type mapping.
     */
    set objectTypeNames(value: Array<cdk.IResolvable | CfnIntegration.ObjectTypeMappingProperty> | cdk.IResolvable | undefined);
    /**
     * Scope of the integration, such as 'PROFILE' or 'DOMAIN'.
     */
...
export declare class CfnObjectType extends cdk.CfnResource implements cdk.IInspectable, IObjectTypeRef, cdk.ITaggable {
     ...
     */
    private _maxProfileObjectCount?;
    /**
     ...
     */
    private _sourceLastUpdatedTimestampFormat?;
    /**
     * Defines the priority order of object types.
     */
    private _sourcePriority?;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly tags: cdk.TagManager;
     ...
     * Indicates whether a profile should be created when data is received if one doesn’t exist for an object of this type.
     */
    get allowProfileCreation(): boolean | cdk.IResolvable | undefined;
    /**
     * Indicates whether a profile should be created when data is received if one doesn’t exist for an object of this type.
     */
    set allowProfileCreation(value: boolean | cdk.IResolvable | undefined);
    /**
     * The description of the profile object type mapping.
     */
     ...
     * A list of field definitions for the object type mapping.
     */
    get fields(): Array<CfnObjectType.FieldMapProperty | cdk.IResolvable> | cdk.IResolvable | undefined;
    /**
     * A list of field definitions for the object type mapping.
     */
    set fields(value: Array<CfnObjectType.FieldMapProperty | cdk.IResolvable> | cdk.IResolvable | undefined);
    /**
     * A list of keys that can be used to map data to the profile or search for the profile.
     */
    get keys(): Array<cdk.IResolvable | CfnObjectType.KeyMapProperty> | cdk.IResolvable | undefined;
    /**
     * A list of keys that can be used to map data to the profile or search for the profile.
     */
    set keys(value: Array<cdk.IResolvable | CfnObjectType.KeyMapProperty> | cdk.IResolvable | undefined);
    /**
     * The amount of profile object max count assigned to the object type.
     */
    get maxProfileObjectCount(): number | undefined;
    /**
     * The amount of profile object max count assigned to the object type.
     */
    set maxProfileObjectCount(value: number | undefined);
    /**
     * The name of the profile object type.
     */
     ...
     * The format of your sourceLastUpdatedTimestamp that was previously set up.
     */
    get sourceLastUpdatedTimestampFormat(): string | undefined;
    /**
     * The format of your sourceLastUpdatedTimestamp that was previously set up.
     */
    set sourceLastUpdatedTimestampFormat(value: string | undefined);
    /**
     * Defines the priority order of object types.
     */
    get sourcePriority(): number | undefined;
    /**
     * Defines the priority order of object types.
     */
    set sourcePriority(value: number | undefined);
    /**
     * The tags used to organize, track, or control access for this resource.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
     ...
     */
    get attrMaxAvailableProfileObjectCount(): number;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare class CfnEventTrigger extends cdk.CfnResource implements cdk.IInspectable, IEventTriggerRef, cdk.ITaggableV2 {
     ...
     */
    private _eventTriggerConditions;
    /**
     * Defines limits controlling whether an event triggers the destination, based on ingestion latency and the number of invocations per profile over specific time periods.
     */
    private _eventTriggerLimits?;
    /**
     * The unique name of the event trigger.
     */
    private _eventTriggerName;
    /**
     ...
     * A list of conditions that determine when an event should trigger the destination.
     */
    get eventTriggerConditions(): Array<CfnEventTrigger.EventTriggerConditionProperty | cdk.IResolvable> | cdk.IResolvable;
    /**
     * A list of conditions that determine when an event should trigger the destination.
     */
    set eventTriggerConditions(value: Array<CfnEventTrigger.EventTriggerConditionProperty | cdk.IResolvable> | cdk.IResolvable);
    /**
     * Defines limits controlling whether an event triggers the destination, based on ingestion latency and the number of invocations per profile over specific time periods.
     */
    get eventTriggerLimits(): CfnEventTrigger.EventTriggerLimitsProperty | cdk.IResolvable | undefined;
    /**
     * Defines limits controlling whether an event triggers the destination, based on ingestion latency and the number of invocations per profile over specific time periods.
     */
    set eventTriggerLimits(value: CfnEventTrigger.EventTriggerLimitsProperty | cdk.IResolvable | undefined);
    /**
     * The unique name of the event trigger.
     */
    get eventTriggerName(): string;
    /**
     * The unique name of the event trigger.
     */
    set eventTriggerName(value: string);
    /**
     * The unique name of the object type.
     */
    get objectTypeName(): string;
     ...
     * The destination is triggered only for profiles that meet the criteria of a segment definition.
     */
    get segmentFilter(): string | undefined;
    /**
     * The destination is triggered only for profiles that meet the criteria of a segment definition.
     */
    set segmentFilter(value: string | undefined);
    /**
     * An array of key-value pairs to apply to this resource.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
 ...
 */
export declare class CfnRecommender extends cdk.CfnResource implements cdk.IInspectable, IRecommenderRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnRecommender from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnRecommender;
    /**
     * Checks whether the given object is a CfnRecommender
     */
    static isCfnRecommender(x: any): x is CfnRecommender;
    static arnForRecommender(resource: IRecommenderRef): string;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
     ...
     */
    private _recommenderConfig?;
    /**
     * The name of the recommender.
     */
    private _recommenderName;
    /**
     * The name of the recommender recipe.
     */
    private _recommenderRecipeName;
    /**
     * The tags used to organize, track, or control access for this resource.
     */
    private _tags?;
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnRecommenderProps);
    get recommenderRef(): RecommenderReference;
    /**
     * The description of the recommender.
     */
    get description(): string | undefined;
     ...
     * Configuration for the recommender.
     */
    get recommenderConfig(): cdk.IResolvable | CfnRecommender.RecommenderConfigProperty | undefined;
    /**
     * Configuration for the recommender.
     */
    set recommenderConfig(value: cdk.IResolvable | CfnRecommender.RecommenderConfigProperty | undefined);
    /**
     * The name of the recommender.
     */
    get recommenderName(): string;
    /**
     * The name of the recommender.
     */
    set recommenderName(value: string);
    /**
     * The name of the recommender recipe.
     */
    get recommenderRecipeName(): string;
    /**
     * The name of the recommender recipe.
     */
    set recommenderRecipeName(value: string);
    /**
     * The tags used to organize, track, or control access for this resource.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
     ...
     */
    get attrLatestRecommenderUpdate(): cdk.IResolvable;
    /**
     * The Amazon Resource Name (ARN) of the recommender.
     *
     * @cloudformationAttribute RecommenderArn
     */
    get attrRecommenderArn(): string;
    /**
     ...
     */
    get attrTrainingMetrics(): cdk.IResolvable;
    protected get cfnProperties(): Record<string, any>;
    /**
     * Examines the CloudFormation resource and discloses attributes
     *
...
export declare namespace CfnRecommender {
    /**
     * Configuration for the recommender.
     *
     * @struct
     ...
     */
    interface RecommenderConfigProperty {
        /**
         ...
         */
        readonly eventsConfig?: CfnRecommender.EventsConfigProperty | cdk.IResolvable;
    }
    /**
     * Configuration for events used in the recommender.
     *
    ...
    interface EventsConfigProperty {
         ...
         */
        readonly eventParametersList: Array<CfnRecommender.EventParametersProperty | cdk.IResolvable> | cdk.IResolvable;
    }
    /**
    ...
    interface RecommenderUpdateProperty {
         ...
         */
        readonly recommenderConfig?: cdk.IResolvable | CfnRecommender.RecommenderConfigProperty;
        /**
         * The status of the recommender.
         *
    ...
    interface TrainingMetricsProperty {
         ...
         */
        readonly metrics?: cdk.IResolvable | CfnRecommender.MetricsProperty;
        /**
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-customerprofiles-recommender.html
 */
export interface CfnRecommenderProps {
    /**
     * The description of the recommender.
     *
...
export declare class CfnSegmentDefinition extends cdk.CfnResource implements cdk.IInspectable, ISegmentDefinitionRef, cdk.ITaggableV2 {
     ...
     * Name of the segment definition.
     */
    get segmentDefinitionName(): string;
    /**
     * Name of the segment definition.
     */
    set segmentDefinitionName(value: string);
    /**
     * Contains all groups of the segment definition.
     */
    get segmentGroups(): cdk.IResolvable | CfnSegmentDefinition.SegmentGroupProperty | undefined;
    /**
     * Contains all groups of the segment definition.
     */
    set segmentGroups(value: cdk.IResolvable | CfnSegmentDefinition.SegmentGroupProperty | undefined);
    /**
     * Defines how segments should be sorted and ordered in the results.
     */
    get segmentSort(): cdk.IResolvable | CfnSegmentDefinition.SegmentSortProperty | undefined;
    /**
     * Defines how segments should be sorted and ordered in the results.
     */
    set segmentSort(value: cdk.IResolvable | CfnSegmentDefinition.SegmentSortProperty | undefined);
    /**
     * The SQL query that defines the segment criteria.
     */
    get segmentSqlQuery(): string | undefined;
    /**
     * The SQL query that defines the segment criteria.
     */
    set segmentSqlQuery(value: string | undefined);
    /**
     * The tags belonging to the segment definition.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
     ...
     */
    get attrSegmentDefinitionArn(): string;
    /**
     * The segment type.
     *
...
export declare namespace CfnSegmentDefinition {
    ...
    interface SegmentSortProperty {
         ...
         */
        readonly attributes: Array<cdk.IResolvable | CfnSegmentDefinition.SortAttributeProperty> | cdk.IResolvable;
    }
    /**
...
export interface CfnSegmentDefinitionProps {
     ...
     */
    readonly segmentSort?: cdk.IResolvable | CfnSegmentDefinition.SegmentSortProperty;
    /**
     * The SQL query that defines the segment criteria.
     *
 ...
 */
export declare class CfnDomainObjectType extends cdk.CfnResource implements cdk.IInspectable, IDomainObjectTypeRef, cdk.ITaggableV2 {
    /**
     * The CloudFormation resource type name for this resource class.
     */
    static readonly CFN_RESOURCE_TYPE_NAME: string;
    /**
     * Build a CfnDomainObjectType from CloudFormation properties
     *
     * A factory method that creates a new instance of this class from an object
     * containing the CloudFormation properties of this resource.
     * Used in the @aws-cdk/cloudformation-include module.
     ...
     * @internal
     */
    static _fromCloudFormation(scope: constructs.Construct, id: string, resourceAttributes: any, options: cfn_parse.FromCloudFormationOptions): CfnDomainObjectType;
    /**
     * Checks whether the given object is a CfnDomainObjectType
     */
    static isCfnDomainObjectType(x: any): x is CfnDomainObjectType;
    /**
     * Tag Manager which manages the tags for this resource
     */
    readonly cdkTagManager: cdk.TagManager;
     ...
     * @param props Resource properties
     */
    constructor(scope: constructs.Construct, id: string, props: CfnDomainObjectTypeProps);
    get domainObjectTypeRef(): DomainObjectTypeReference;
    /**
     * Description of the domain object type.
     */
    get description(): string | undefined;
     ...
     * A map of the name and ObjectType field.
     */
    get fields(): cdk.IResolvable | Record<string, CfnDomainObjectType.DomainObjectTypeFieldProperty | cdk.IResolvable>;
    /**
     * A map of the name and ObjectType field.
     */
    set fields(value: cdk.IResolvable | Record<string, CfnDomainObjectType.DomainObjectTypeFieldProperty | cdk.IResolvable>);
    /**
     * The name of the domain object type.
     */
    get objectTypeName(): string;
...
export declare namespace CfnDomainObjectType {
    /**
 ...
 * @see http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-resource-customerprofiles-domainobjecttype.html
 */
export interface CfnDomainObjectTypeProps {
    /**
     * Description of the domain object type.
     *
     ...
     */
    readonly fields: cdk.IResolvable | Record<string, CfnDomainObjectType.DomainObjectTypeFieldProperty | cdk.IResolvable>;
    /**
     * The name of the domain object type.
     *
...
export type { IRecommenderRef, RecommenderReference };
export type { ISegmentDefinitionRef, SegmentDefinitionReference };
export type { IDomainObjectTypeRef, DomainObjectTypeReference };
