...
import { DBClusterParameterGroupReference, DBClusterReference, DBInstanceReference, DBParameterGroupReference, DBSubnetGroupReference, EventSubscriptionReference, IDBClusterParameterGroupRef, IDBClusterRef, IDBInstanceRef, IDBParameterGroupRef, IDBSubnetGroupRef, IEventSubscriptionRef } from "../../interfaces/generated/aws-neptune-interfaces.generated";
/**
...
export declare class CfnDBCluster extends cdk.CfnResource implements cdk.IInspectable, IDBClusterRef, cdk.ITaggable {
     ...
     */
    private _serverlessScalingConfiguration?;
    /**
     ...
     * The port number on which the DB instances in the DB cluster accept connections.
     */
    set dbPort(value: number | undefined);
    /**
     * Specifies information on the subnet group associated with the DB cluster, including the name, description, and subnets in the subnet group.
     */
     ...
     * True if mapping of Amazon Identity and Access Management (IAM) accounts to database accounts is enabled, and otherwise false.
     */
    get iamAuthEnabled(): boolean | cdk.IResolvable | undefined;
    /**
     * True if mapping of Amazon Identity and Access Management (IAM) accounts to database accounts is enabled, and otherwise false.
     */
    set iamAuthEnabled(value: boolean | cdk.IResolvable | undefined);
    /**
     * The Amazon Resource Name (ARN) of the KMS key that is used to encrypt the database instances in the DB cluster, such as `arn:aws:kms:us-east-1:012345678910:key/abcd1234-a123-456a-a12b-a123b4cd56ef` .
     */
     ...
     * Contains the scaling configuration of an Neptune Serverless DB cluster.
     */
    get serverlessScalingConfiguration(): cdk.IResolvable | CfnDBCluster.ServerlessScalingConfigurationProperty | undefined;
    /**
     * Contains the scaling configuration of an Neptune Serverless DB cluster.
     */
    set serverlessScalingConfiguration(value: cdk.IResolvable | CfnDBCluster.ServerlessScalingConfigurationProperty | undefined);
    /**
     * Specifies the identifier for a DB cluster snapshot. Must match the identifier of an existing snapshot.
     */
