...
export declare class CfnAssistant extends cdk.CfnResource implements cdk.IInspectable, IAssistantRef, cdk.ITaggable {
     ...
     * The configuration information for the customer managed key used for encryption.
     */
    get serverSideEncryptionConfiguration(): cdk.IResolvable | CfnAssistant.ServerSideEncryptionConfigurationProperty | undefined;
    /**
     * The configuration information for the customer managed key used for encryption.
     */
    set serverSideEncryptionConfiguration(value: cdk.IResolvable | CfnAssistant.ServerSideEncryptionConfigurationProperty | undefined);
    /**
     * The tags used to organize, track, or control access for this resource.
     */
...
export declare class CfnAssistantAssociation extends cdk.CfnResource implements cdk.IInspectable, IAssistantAssociationRef, cdk.ITaggable {
     ...
     * The identifier of the associated resource.
     */
    get association(): CfnAssistantAssociation.AssociationDataProperty | cdk.IResolvable;
    /**
     * The identifier of the associated resource.
     */
    set association(value: CfnAssistantAssociation.AssociationDataProperty | cdk.IResolvable);
    /**
     * The type of association.
     */
     ...
     * The type of association.
     */
    set associationType(value: string);
    /**
     * The tags used to organize, track, or control access for this resource.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
...
export declare class CfnKnowledgeBase extends cdk.CfnResource implements cdk.IInspectable, IKnowledgeBaseRef, cdk.ITaggable {
     ...
     */
    private _renderingConfiguration?;
    /**
     ...
     * The type of knowledge base.
     */
    get knowledgeBaseType(): string;
    /**
     * The type of knowledge base.
     */
    set knowledgeBaseType(value: string);
    /**
     * The name of the knowledge base.
     */
    get name(): string;
     ...
     * Information about how to render the content.
     */
    get renderingConfiguration(): cdk.IResolvable | CfnKnowledgeBase.RenderingConfigurationProperty | undefined;
    /**
     * Information about how to render the content.
     */
    set renderingConfiguration(value: cdk.IResolvable | CfnKnowledgeBase.RenderingConfigurationProperty | undefined);
    /**
     * This customer managed key must have a policy that allows `kms:CreateGrant` and `kms:DescribeKey` permissions to the IAM identity using the key to invoke Wisdom.
     */
    get serverSideEncryptionConfiguration(): cdk.IResolvable | CfnKnowledgeBase.ServerSideEncryptionConfigurationProperty | undefined;
    /**
     * This customer managed key must have a policy that allows `kms:CreateGrant` and `kms:DescribeKey` permissions to the IAM identity using the key to invoke Wisdom.
     */
    set serverSideEncryptionConfiguration(value: cdk.IResolvable | CfnKnowledgeBase.ServerSideEncryptionConfigurationProperty | undefined);
    /**
     * The source of the knowledge base content.
     */
    get sourceConfiguration(): cdk.IResolvable | CfnKnowledgeBase.SourceConfigurationProperty | undefined;
    /**
     * The source of the knowledge base content.
     */
    set sourceConfiguration(value: cdk.IResolvable | CfnKnowledgeBase.SourceConfigurationProperty | undefined);
    /**
     * The tags used to organize, track, or control access for this resource.
     */
    get tagsRaw(): Array<cdk.CfnTag> | undefined;
     ...
     * Contains details about how to ingest the documents in a data source.
     */
    get vectorIngestionConfiguration(): cdk.IResolvable | CfnKnowledgeBase.VectorIngestionConfigurationProperty | undefined;
    /**
     * Contains details about how to ingest the documents in a data source.
     */
    set vectorIngestionConfiguration(value: cdk.IResolvable | CfnKnowledgeBase.VectorIngestionConfigurationProperty | undefined);
    /**
...
export declare class CfnAIAgent extends cdk.CfnResource implements cdk.IInspectable, IAIAgentRef, cdk.ITaggableV2 {
     ...
     * Configuration for the AI Agent.
     */
    get configuration(): CfnAIAgent.AIAgentConfigurationProperty | cdk.IResolvable;
    /**
     * Configuration for the AI Agent.
     */
    set configuration(value: CfnAIAgent.AIAgentConfigurationProperty | cdk.IResolvable);
    /**
     * The description of the AI Agent.
     */
    get description(): string | undefined;
...
export declare class CfnAIAgentVersion extends cdk.CfnResource implements cdk.IInspectable, IAIAgentVersionRef {
     ...
     * The time the AI Agent version was last modified in seconds.
     */
    get modifiedTimeSeconds(): number | undefined;
    /**
     * The time the AI Agent version was last modified in seconds.
     */
    set modifiedTimeSeconds(value: number | undefined);
    /**
     * @cloudformationAttribute AIAgentArn
     */
    get attrAiAgentArn(): string;
...
export declare class CfnAIGuardrail extends cdk.CfnResource implements cdk.IInspectable, IAIGuardrailRef, cdk.ITaggableV2 {
     ...
     * Contains details about how to handle harmful content.
     */
    get contentPolicyConfig(): CfnAIGuardrail.AIGuardrailContentPolicyConfigProperty | cdk.IResolvable | undefined;
    /**
     * Contains details about how to handle harmful content.
     */
    set contentPolicyConfig(value: CfnAIGuardrail.AIGuardrailContentPolicyConfigProperty | cdk.IResolvable | undefined);
    /**
     * The policy configuration details for the AI Guardrail's contextual grounding policy.
     */
    get contextualGroundingPolicyConfig(): CfnAIGuardrail.AIGuardrailContextualGroundingPolicyConfigProperty | cdk.IResolvable | undefined;
    /**
     * The policy configuration details for the AI Guardrail's contextual grounding policy.
     */
    set contextualGroundingPolicyConfig(value: CfnAIGuardrail.AIGuardrailContextualGroundingPolicyConfigProperty | cdk.IResolvable | undefined);
    /**
     * A description of the AI Guardrail.
     */
    get description(): string | undefined;
     ...
     * Contains details about PII entities and regular expressions to configure for the AI Guardrail.
     */
    get sensitiveInformationPolicyConfig(): CfnAIGuardrail.AIGuardrailSensitiveInformationPolicyConfigProperty | cdk.IResolvable | undefined;
    /**
     * Contains details about PII entities and regular expressions to configure for the AI Guardrail.
     */
    set sensitiveInformationPolicyConfig(value: CfnAIGuardrail.AIGuardrailSensitiveInformationPolicyConfigProperty | cdk.IResolvable | undefined);
    /**
     * The tags used to organize, track, or control access for this resource.
     */
    get tags(): Record<string, string> | undefined;
     ...
     * Contains details about topics that the AI Guardrail should identify and deny.
     */
    get topicPolicyConfig(): CfnAIGuardrail.AIGuardrailTopicPolicyConfigProperty | cdk.IResolvable | undefined;
    /**
     * Contains details about topics that the AI Guardrail should identify and deny.
     */
    set topicPolicyConfig(value: CfnAIGuardrail.AIGuardrailTopicPolicyConfigProperty | cdk.IResolvable | undefined);
    /**
     * Contains details about the word policy to configured for the AI Guardrail.
     */
    get wordPolicyConfig(): CfnAIGuardrail.AIGuardrailWordPolicyConfigProperty | cdk.IResolvable | undefined;
    /**
     * Contains details about the word policy to configured for the AI Guardrail.
     */
    set wordPolicyConfig(value: CfnAIGuardrail.AIGuardrailWordPolicyConfigProperty | cdk.IResolvable | undefined);
    /**
...
export declare class CfnAIGuardrailVersion extends cdk.CfnResource implements cdk.IInspectable, IAIGuardrailVersionRef {
     ...
     * The ID of the AI guardrail version.
     */
    get aiGuardrailId(): string;
    /**
     * The ID of the AI guardrail version.
     */
    set aiGuardrailId(value: string);
    /**
     * The ID of the AI guardrail version assistant.
     */
    get assistantId(): string;
...
export declare class CfnAIPrompt extends cdk.CfnResource implements cdk.IInspectable, IAIPromptRef, cdk.ITaggableV2 {
     ...
     * The API format used for this AI Prompt.
     */
    get apiFormat(): string;
    /**
     * The API format used for this AI Prompt.
     */
    set apiFormat(value: string);
    /**
     * The identifier of the Amazon Q in Connect assistant.
     */
     ...
     * The identifier of the Amazon Q in Connect assistant.
     */
    set assistantId(value: string | undefined);
    /**
     * The description of the AI Prompt.
     */
    get description(): string | undefined;
     ...
     * The configuration of the prompt template for this AI Prompt.
     */
    get templateConfiguration(): CfnAIPrompt.AIPromptTemplateConfigurationProperty | cdk.IResolvable;
    /**
     * The configuration of the prompt template for this AI Prompt.
     */
    set templateConfiguration(value: CfnAIPrompt.AIPromptTemplateConfigurationProperty | cdk.IResolvable);
    /**
     * The type of the prompt template for this AI Prompt.
     */
...
export declare class CfnMessageTemplate extends cdk.CfnResource implements cdk.IInspectable, IMessageTemplateRef, cdk.ITaggableV2 {
     ...
     */
    private _groupingConfiguration?;
    /**
     * The Amazon Resource Name (ARN) of the knowledge base.
     */
    private _knowledgeBaseArn;
    /**
     ...
     */
    private _messageTemplateAttachments?;
    /**
     ...
     * The channel subtype this message template applies to.
     */
    get channelSubtype(): string;
    /**
     * The channel subtype this message template applies to.
     */
    set channelSubtype(value: string);
    /**
     * The content of the message template.
     */
    get content(): CfnMessageTemplate.ContentProperty | cdk.IResolvable;
    /**
     * The content of the message template.
     */
    set content(value: CfnMessageTemplate.ContentProperty | cdk.IResolvable);
    /**
     * An object that specifies the default values to use for variables in the message template.
     */
    get defaultAttributes(): cdk.IResolvable | CfnMessageTemplate.MessageTemplateAttributesProperty | undefined;
    /**
     * An object that specifies the default values to use for variables in the message template.
     */
    set defaultAttributes(value: cdk.IResolvable | CfnMessageTemplate.MessageTemplateAttributesProperty | undefined);
    /**
     * The description of the message template.
     */
    get description(): string | undefined;
     ...
     * The configuration information of the external data source.
     */
    get groupingConfiguration(): CfnMessageTemplate.GroupingConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * The configuration information of the external data source.
     */
    set groupingConfiguration(value: CfnMessageTemplate.GroupingConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * The Amazon Resource Name (ARN) of the knowledge base.
     */
    get knowledgeBaseArn(): string;
    /**
     * The Amazon Resource Name (ARN) of the knowledge base.
     */
    set knowledgeBaseArn(value: string);
    /**
     * The language code value for the language in which the quick response is written.
     */
     ...
     * List of message template attachments.
     */
    get messageTemplateAttachments(): Array<cdk.IResolvable | CfnMessageTemplate.MessageTemplateAttachmentProperty> | cdk.IResolvable | undefined;
    /**
     * List of message template attachments.
     */
    set messageTemplateAttachments(value: Array<cdk.IResolvable | CfnMessageTemplate.MessageTemplateAttachmentProperty> | cdk.IResolvable | undefined);
    /**
     * The name of the message template.
     */
    get name(): string;
...
export declare class CfnMessageTemplateVersion extends cdk.CfnResource implements cdk.IInspectable, IMessageTemplateVersionRef {
     ...
     * The Amazon Resource Name (ARN) of the message template.
     */
    private _messageTemplateArn;
    /**
     * The content SHA256 of the message template.
     */
    private _messageTemplateContentSha256?;
    protected readonly cfnPropertyNames: Record<string, string>;
    /**
     ...
     * The Amazon Resource Name (ARN) of the message template.
     */
    get messageTemplateArn(): string;
    /**
     * The Amazon Resource Name (ARN) of the message template.
     */
    set messageTemplateArn(value: string);
    /**
     * The content SHA256 of the message template.
     */
    get messageTemplateContentSha256(): string | undefined;
    /**
     * The content SHA256 of the message template.
     */
    set messageTemplateContentSha256(value: string | undefined);
    /**
...
export declare class CfnQuickResponse extends cdk.CfnResource implements cdk.IInspectable, IQuickResponseRef, cdk.ITaggableV2 {
     ...
     * The Amazon Connect contact channels this quick response applies to.
     */
    get channels(): Array<string> | undefined;
    /**
     * The Amazon Connect contact channels this quick response applies to.
     */
    set channels(value: Array<string> | undefined);
    /**
     * The content of the quick response.
     */
    get content(): cdk.IResolvable | CfnQuickResponse.QuickResponseContentProviderProperty;
    /**
     * The content of the quick response.
     */
    set content(value: cdk.IResolvable | CfnQuickResponse.QuickResponseContentProviderProperty);
    /**
     * The media type of the quick response content.
     */
     ...
     * The configuration information of the user groups that the quick response is accessible to.
     */
    get groupingConfiguration(): CfnQuickResponse.GroupingConfigurationProperty | cdk.IResolvable | undefined;
    /**
     * The configuration information of the user groups that the quick response is accessible to.
     */
    set groupingConfiguration(value: CfnQuickResponse.GroupingConfigurationProperty | cdk.IResolvable | undefined);
    /**
     * Whether the quick response is active.
     */
    get isActive(): boolean | cdk.IResolvable | undefined;
    /**
     * Whether the quick response is active.
     */
    set isActive(value: boolean | cdk.IResolvable | undefined);
    /**
     * The Amazon Resource Name (ARN) of the knowledge base.
     */
    get knowledgeBaseArn(): string;
     ...
     * The shortcut key of the quick response.
     */
    set shortcutKey(value: string | undefined);
    /**
     * The tags used to organize, track, or control access for this resource.
     */
    get tags(): Array<cdk.CfnTag> | undefined;
