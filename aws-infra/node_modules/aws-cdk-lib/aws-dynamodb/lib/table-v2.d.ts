...
export declare class TableV2 extends TableBaseV2 {
     ...
     * @param statement The policy statement to add
     */
    addToStreamResourcePolicy(statement: PolicyStatement): AddToResourcePolicyResult;
    /**
     * Add a replica table.
     *
    ...
    private renderReplicaStreamSpecification;
...
export declare class TableV2MultiAccountReplica extends TableBaseV2 {
     ...
     * @attribute
     */
    get resourcePolicy(): PolicyDocument | undefined;
    set resourcePolicy(value: PolicyDocument | undefined);
    private readonly _resourcePolicy;
    /**
     * Resource policy associated with this table's stream.
     */
    get streamResourcePolicy(): PolicyDocument | undefined;
    set streamResourcePolicy(value: PolicyDocument | undefined);
    private readonly _streamResourcePolicy;
    /**
     * Grants for this table
     */
    readonly grants: TableGrants;
