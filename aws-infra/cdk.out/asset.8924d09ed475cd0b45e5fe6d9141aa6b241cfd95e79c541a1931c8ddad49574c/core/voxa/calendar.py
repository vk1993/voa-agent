...
SHOWROOM_MAP: dict[str, dict] = {
    "560066": {"name": "Whitefield", "calendar_id": "whitefield@prestige.voxa.ai", "designer": "Aarav Nair"},
    "560048": {"name": "Whitefield", "calendar_id": "whitefield@prestige.voxa.ai", "designer": "Aarav Nair"},
    "560037": {"name": "Whitefield", "calendar_id": "whitefield@prestige.voxa.ai", "designer": "Aarav Nair"},
    "560102": {"name": "HSR Layout", "calendar_id": "hsr@prestige.voxa.ai",        "designer": "Rahul Mehta"},
    "560034": {"name": "HSR Layout", "calendar_id": "hsr@prestige.voxa.ai",        "designer": "Rahul Mehta"},
    "560068": {"name": "HSR Layout", "calendar_id": "hsr@prestige.voxa.ai",        "designer": "Rahul Mehta"},
    "560100": {"name": "Electronics City", "calendar_id": "ecity@prestige.voxa.ai","designer": "Sneha Rao"},
    "560105": {"name": "Electronics City", "calendar_id": "ecity@prestige.voxa.ai","designer": "Sneha Rao"},
    "560029": {"name": "Electronics City", "calendar_id": "ecity@prestige.voxa.ai","designer": "Sneha Rao"},
}
DEFAULT_SHOWROOM = {"name": "Bengaluru", "calendar_id": "general@prestige.voxa.ai", "designer": "Riya Mehta"}
...
class GoogleCalendarService:
    ...
    def lookup_showroom(self, pincode: str) -> dict:
        return SHOWROOM_MAP.get(pincode.strip(), DEFAULT_SHOWROOM)
    ...
    async def create_appointment(
        ...
        client_name: str, project_type: str,
        designer_name: str, showroom_name: str,
        ...
        token = await self._get_token()
        body = {
            "summary": f"{client_name} — {project_type} consultation",
            "description": (
